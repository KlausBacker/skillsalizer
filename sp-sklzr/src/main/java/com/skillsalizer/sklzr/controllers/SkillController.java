...
public class SkillController {
    ...
    @Autowired
    public SkillController(SkillService skLevelService){this.skLevelService=skLevelService;}
    ...
    //Delete an Skill by is ID using the Service's "deleteSkillById()" function
